...
public class DefineCode {
    ...
    public interface GDFEntity {
        ...
        public static final String FUNCTION = "function-search";
    }
    ...
    public static enum CommonService implements ChatbotService {
        ...
        FUNCTION_SEARCH("function-search","기능검색");
    ...
    public static enum Intent {
        ...
        , FUNCTION(7, "function-search", Arrays.asList(GDFEntity.FUNCTION), false)
