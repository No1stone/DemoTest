...
public class Message {
	...
	public String toString() {
		return "Message [id=" + id + ", roomId=" + roomId + ", toPersonId=" + toPersonId + ", toPersonEmail="
				+ toPersonEmail + ", personId=" + personId + ", personEmail=" + personEmail + ", text=" + text
				+ ", file=" + file + ", roomType=" + roomType + ", created=" + created + ", files="
				+ Arrays.toString(files) + ", markdown=" + markdown + ", html=" + html + ", mentionedPeople="
				+ Arrays.toString(mentionedPeople) + ", attachments=" + attachments + "]";
	} 
